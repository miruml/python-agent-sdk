...
from miru_agent import MiruAgent, AsyncMiruAgent, DefaultAioHttpClient
from miru_agent._utils import is_dict
...
logging.getLogger("miru_agent").setLevel(logging.DEBUG)
...
def client(request: FixtureRequest) -> Iterator[MiruAgent]:
    ...
    with MiruAgent(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
