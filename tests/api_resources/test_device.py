...
from miru_agent.types import DeviceSyncResponse, DeviceRetrieveResponse
...
class TestDevice:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_sync(self, client: MiruAgent) -> None:
        device = client.device.sync()
        assert_matches_type(DeviceSyncResponse, device, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_sync(self, client: MiruAgent) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_sync(self, client: MiruAgent) -> None:
...
class TestAsyncDevice:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_sync(self, async_client: AsyncMiruAgent) -> None:
        device = await async_client.device.sync()
        assert_matches_type(DeviceSyncResponse, device, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_sync(self, async_client: AsyncMiruAgent) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_sync(self, async_client: AsyncMiruAgent) -> None:
